...
if __name__ == "__main__":
    ...
    # 构造目标位姿：保持当前姿态不变，仅将 z 轴向下移动 0.1 m
    target_translation = current_pose.translation.copy()
    target_translation[2] -= 0.1
    target_pose = pin.SE3(current_pose.rotation, target_translation)
    print("\n目标末端位姿:")
