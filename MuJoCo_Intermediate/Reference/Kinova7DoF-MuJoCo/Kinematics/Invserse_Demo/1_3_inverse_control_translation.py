...
class JoystickControl(QWidget):
    ...
    def initUI(self):
        ...
        # ✅ 第二个摇杆：控制 Z
        self.joystick_z = Joystick()
        joystick_layout.addWidget(self.joystick_z)
        ...
        self.joystick_z.joystick_moved.connect(self.update_z_position)
    ...
    def update_z_position(self, _, y):
        """更新 Z 轴的增量"""
        self.delta_z = y * 0.05  # 只使用 Y 方向数据，X 方向忽略

    def update_robot_position(self):
        """更新机械臂位置"""
        self.robot.move_to_position(self.delta_x, self.delta_y, self.delta_z)
